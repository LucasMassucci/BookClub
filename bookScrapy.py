...
def extract_data(rows: list, category: str):
    ...
    data = {
            ...
            'category': [category] * len(row_texts)
            }
...
def extration_clycle(url, category, engine, schema='book_club', table='books'):
    driver.get(url)
